    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="bg-card border border-border rounded-xl p-5">
          ...
          <div className="text-3xl font-bold text-orange-500">{data.openCount.toLocaleString()}</div>
        </div>
        <div className="bg-card border border-border rounded-xl p-5">
          <div className="text-xs text-muted-foreground uppercase tracking-wide mb-2">Closed Issues</div>
          <div className="text-3xl font-bold text-green-500">{data.closedCount.toLocaleString()}</div>
